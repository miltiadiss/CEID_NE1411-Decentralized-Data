...
lr_regressor = LinearRegression(featuresCol="scaled_features", 
                                labelCol="average_docking_station_utilisation", 
                                regParam=0.01,  # Regularization parameter to avoid overfitting
                                elasticNetParam=0.8)  # ElasticNet regularization
...
next_hour_prediction = lr_model.transform(next_hour_scaled)
